...
export const cardOptions = [
  { key: 'visa', value: 'visa', icon: 'visa', text: 'Visa' },
  { key: 'american express', value: 'american express', icon: 'american express', text: 'American Express' },
  { key: 'discover', value: 'discover', icon: 'discover', text: 'Discover' },
  { key: 'paypal', value: 'paypal', icon: 'paypal', text: 'Paypal' },
  { key: 'google wallet', value: 'google wallet', icon: 'google wallet', text: 'Google Wallet' },
]
